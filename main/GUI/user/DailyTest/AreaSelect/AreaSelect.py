...
from func.user.DailyTest import daily_test
...
class AreaSelect:
    def __init__(self):
        ...
        image = self.canvas.create_image(180.0, 250.0, image=image_image)

        image_image_1 = PhotoImage(file=relative_to_assets("image-1.png"))
        image_1 = self.canvas.create_image(850.0, 200.0, image=image_image_1)

        image_image_2 = PhotoImage(file=relative_to_assets("image-2.png"))
        image_2 = self.canvas.create_image(840.0, 300.0, image=image_image_2)

        image_image_3 = PhotoImage(file=relative_to_assets("image-3.png"))
        image_3 = self.canvas.create_image(180.0, 240.0, image=image_image_3)

        entry_image = PhotoImage(file=relative_to_assets("TextBox.png"))
        entry = self.canvas.create_image(610.0, 300.0, image=entry_image)
        ...
        self.entry.place(x=480.0, y=170.0, width=260.0, height=60.0)

        entry_image_1 = PhotoImage(file=relative_to_assets("TextBox-1.png"))
        entry_1 = self.canvas.create_image(610.0, 200.0, image=entry_image_1)
        ...
        self.entry_1.place(x=480.0, y=270.0, width=260.0, height=60.0)

        button_image = PhotoImage(file=relative_to_assets("Button.png"))
        temp = self.canvas.create_image(990.0, 433.0, image=button_image)
